...
- es liegen n unterscheidbare Elemente 
...
\[n = n_1 + n_2 + \dots + n_k, \quad \text{wobei die } n_k \text{ unterscheidbar sind } (k \le n)\]
...
→ die Anordnungen, die aufgrund des Nicht-Unterscheidbarkeit von
...
→ es wird unterschieden, ob Elemente nur einmal oder mehrmals gezogen
werden können 
