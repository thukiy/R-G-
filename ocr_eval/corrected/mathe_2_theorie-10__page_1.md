...
z. B. \(\int e^{-t^2} \, dt\) nicht analytisch lösbar 

<|ref|>sub_title<|/ref|><|det|>[[25, 656, 201, 683]]<|/det|>
## Trapezformel 

<|ref|>text<|/ref|><|det|>[[45, 695, 901, 765]]<|/det|>
\(f: \mathbb{R} \to \mathbb{R}\), Integrationsintervall: \(a \le x \le b\) zerlege \([a,b]\) in \(n\) gleich
grosse Teilintervalle der Länge \(h = \frac{b-a}{n}\) 

<|ref|>text<|/ref|><|det|>[[75, 793, 780, 858]]<|/det|>
→ Stützstellen: \(x_0 = a\), \(x_1 = x_0 + h\), \(x_2 = x_0 + 2h\) ...
\(x_n = b\) 

<|ref|>text<|/ref|><|det|>[[75, 868, 770, 897]]<|/det|>
→ Funktionswelt an Stützstelle: \(f(x_n)\) heisst Stützwert 
